...
export const AuthProvider = ({ children }) => {
    ...
    const register = async (name, email, password, role, adminRegistrationCode) => {
        try {
            const { data } = await api.post('/auth/register', { name, email, password, role, adminRegistrationCode });
